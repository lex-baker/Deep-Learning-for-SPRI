...
if __name__ == '__main__':
    ...
    #pin_memory increases data tranfser speeds on CUDE-enabled GPUs
    ...
    class MnistModel(nn.Module):
        #Feedfoward neural network with 2 hidden layers
    ...
    input_size = 784
    hidden1_size = 32 # you can change this
    hidden2_size = 32
    num_classes = 10
    ...
    # Model (on GPU)
    model = MnistModel(input_size, hidden1_size, hidden2_size, out_size=num_classes)
